          ...
          <div className="bg-cream rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg font-semibold text-gray-900">{formatDate(user?.date_joined)}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-cream rounded-xl shadow-lg p-6 border border-gray-100">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <span className="text-sm text-gray-900">{user?.first_name || 'Not provided'}</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-sm font-medium text-gray-600">Last Name</span>
                <span className="text-sm text-gray-900">{user?.last_name || 'Not provided'}</span>
              </div>
            </div>
          </div>
              ...
              <button className="w-full text-left p-4 rounded-lg border border-gray-200 hover:border-purple-300 hover:bg-purple-50 transition-colors group cursor-pointer">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Check your activity statistics</p>
                  </div>
                </div>
              </button>
            </div>
